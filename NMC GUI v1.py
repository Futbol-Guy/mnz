...
class Help_two_UI:
        def __init__(self,root,bg_image):
                ...
                self.main_canvas.create_text(430,150, text = "For more useful information and help, ",anchor=NW,font=self.customFont_small)
                ...
                self.obj1Id = self.main_canvas.create_text(650,150,activefill="#33adff",text='take a look at our website', fill="#0099ff",tags='obj1Tag',anchor=NW,font=self.customFont_small)
